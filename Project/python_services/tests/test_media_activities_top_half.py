...
async def test_top_half_browser_capture(MockStorage, MockBrowser, MockImageGen):
    # Setup mocks
    ...
    mock_storage_instance.upload_file.return_value = "https://mocked.com/browser_captures/fake.png"
    ...
    with patch("builtins.open", mock_open(read_data=b"fake_image_data")), patch("os.makedirs"), patch("os.path.exists", return_value=True):
        ...
        assert results[0]["image_url"] == "https://mocked.com/browser_captures/fake.png"
        mock_browser_instance.record_video_for_tutorial.assert_called_once_with("https://example.com")
