    ...
    async def _dream_persona_details(
        ...
        try:
            ...
            if "401" in error_msg or "invalid_api_key" in error_msg.lower():
                error_msg = "OpenAI API key is invalid or missing. Please check your VPS environment variables or .env file."
            ...
            return {
                ...
                "appearance": brief,
                "error": error_msg,
                "debug_info": error_details[:500] if getattr(settings, "DEBUG", False) else None
            }
